                ...
                @forelse($sucursales as $sucursal)
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('sucursales.edit', $sucursal->id_sucursal) }}" class="btn btn-sm btn-primary">Editar</a>
                            <form action="{{ route('sucursales.destroy', $sucursal->id_sucursal) }}" method="POST" style="display:inline-block;" onsubmit="return confirm('¿Estás seguro de eliminar esta sucursal?')">
                                @csrf
                                @method('DELETE')
