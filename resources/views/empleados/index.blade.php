...
@section('content')
    <div class="container py-4">
        ...
        <div class="mb-3 d-flex gap-2">
            ...
            <a href="{{ route('empleados.exportarPdfGeneral') }}" class="btn btn-outline-danger shadow-sm" target="_blank">
                ...
                <tbody>
                    @forelse($empleados as $empleado)
                        <tr>
                            ...
                            <td>
                                <span
                                    class="badge rounded-pill bg-{{ $empleado->status === 'activo' ? 'success' : 'secondary' }}">
                            ...
                            <td class="text-center">
                                ...
                                <a href="{{ route('empleados.pdf', $empleado->id_empleado) }}"
                                    class="btn btn-sm btn-outline-danger me-1" title="Ver PDF" target="_blank">
        ...
        @if ($empleados->total() > 0)
            <div class="d-flex justify-content-between align-items-center mt-3">
                <div class="text-muted">
                    Mostrando <strong>{{ $empleados->firstItem() }}</strong> a <strong>{{ $empleados->lastItem() }}</strong> de
                    <strong>{{ $empleados->total() }}</strong> resultados
                </div>
                <div>
